...
sub print_menu {
                print p("start of print_menu") if $DEBUG;       # debug option indicates on screen that this sub has started
                my $id = param("id");
...
#                print p(" <a href=create_shiai.cgi?id=$id>Create a Shiai</a>");
                ...
                print p("end of print_menu") if $DEBUG;         # debug option, shows the end of this sub
}
...
print header(), start_html("e-Judo Test Area"), h1("Main Menu"); # This line uses CGI.PM to to create the webpage
